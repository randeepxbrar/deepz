...
public class CardTrick {
  ...
  // ask user for card value and suit
    ...
    private static void printInfo() {
        ...
        System.out.println("My name is randeep");
        System.out.println();
        
        System.out.println("My career ambitions:");
        System.out.println("-- be the best version of myself");
        System.out.println("-- have a good time wile doing so");
	System.out.println();	

        System.out.println("My hobbies:");
        System.out.println("-- chilling");
        System.out.println("-- gaames");
